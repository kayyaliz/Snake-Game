    ...
    */
        ...
        return function(inputConfig) {
            ...
            function createBoardElements() {
                ...
                elmPauseScreen.innerHTML = "<div style='padding:10px;'>SNIPER SNAKE<p/>Press <u>space</u> to resume onslaught.</div>";
            ...
            function createWelcomeElement() {
                ...
                welcomeTxt.innerHTML = "SNIPER SNAKE<p></p>Use the <u>arrow keys</u> on your keyboard to play the game. " + fullScreenText + "<p></p>";
                var welcomeStart = document.createElement("button");
                welcomeStart.className = 'btn btn-default';
            ...
            function createTryAgainElement() {
                ...
                tryAgainTxt.innerHTML = "SNIPER SNAKE<p></p>You have been vanquished.<p></p>";
                var tryAgainStart = document.createElement("button");
                tryAgainStart.className = 'btn btn-default';
    ...
    var h1 = document.getElementById('timerHeader'),
    ...
    function getHighScore () {   
        ...
        if (localStorage.jsSnakeHighScore == undefined) {
            localStorage.jsSnakeHighScore = 0;
        }
        $("#high-score").text(localStorage.jsSnakeHighScore);
    }
